...
<div class="row mb-4">
    <div class="col-8">
        <h2><i class="bi bi-pencil"></i> Modifier Congé</h2>
    </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="agent_id" class="form-select @error('agent_id') is-invalid @enderror">
                        ...
                        <option value="{{ $agent->id }}" {{ old('agent_id', $conge->agent_id) == $agent->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="jours_a_prendre" class="form-control @error('jours_a_prendre') is-invalid @enderror"
                        value="{{ old('jours_a_prendre', $conge->jours_a_prendre) }}" min="1">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="date_cessation" class="form-control @error('date_cessation') is-invalid @enderror"
                        value="{{ old('date_cessation', $conge->date_cessation->format('Y-m-d')) }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="statut" class="form-select @error('statut') is-invalid @enderror">
                        ...
                        <option value="refuse" {{ old('statut', $conge->statut) == 'refuse' ? 'selected' : '' }}>Refusé</option>
                    </select>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="exceptionnel" class="form-check-input" value="1"
                            {{ old('exceptionnel', $conge->exceptionnel) ? 'checked' : '' }}>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="deductible" class="form-check-input" value="1"
                            {{ old('deductible', $conge->deductible) ? 'checked' : '' }}>
                        <label class="form-check-label">Oui</label>
                    </div>
                </div>
            </div>
